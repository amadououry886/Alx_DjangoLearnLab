...
class BookAPITestCase(TestCase):
    ...
    def test_create_book_authenticated(self):
        ...
        self.assertEqual(response.data['author'], self.valid_data['author'])  # ✅ Validate author
        self.assertEqual(response.data['genre'], self.valid_data['genre'])
    ...
    def test_create_book_unauthenticated(self):
        ...
        self.assertIn('detail', response.data)  # ✅ Ensure error detail exists
    ...
    def test_update_book_authenticated(self):
        ...
        self.assertEqual(response.data['author'], self.author_a.id)
    ...
    def test_delete_book_authenticated(self):
        ...
        self.assertEqual(response.data, None)  # ✅ Ensure response is empty
    ...
    def test_delete_book_unauthenticated(self):
        ...
        response = self.client.delete(f'/api/books/{self.book1.id}/')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertIn('detail', response.data)  # ✅ Check response data
